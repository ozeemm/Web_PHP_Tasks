...
--
-- Хост: localhost:3307
-- Время создания: Май 13 2024 г., 18:47
...
(8, 'njkbnhj', NULL, 'bsddbfgh', 'sfgsfg', 'Другие'),
(9, 'Добавлятор Картинок', '/media/File_Adder.gif', 'Он добавляет картинки', 'Он добавляет картинки. Обычно у него это получается, но сейчас просто звёзды не так сошлись.', 'Люди'),
(12, 'Робот-гедонист', '/media/gedonist.jpg', 'Тут расскажем про робота-гедониста', 'Робот, ставящий целью своей жизни получение наслаждений. \r\nИмеет цвет и блеск золота и подобие лаврового венка на голове. \r\nПостоянно лежит и передвигается на кушетке, которая является частью его корпуса, и непрерывно поглощает виноград.', 'Роботы');
